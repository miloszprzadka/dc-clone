...
const Footer = () => {
  return (
    <div className=''>
        <section className='bg-[#23272a] mx-auto justify-center flex pt-20  lg:flex-col'>
          <div className='mr-20 lg:mr-0 '>
            <select className='text-white bg-[#23272a] text-[14px] lg:ml-10'>
              <option>
                Polski
              </option>
              <option>
            ...
            <div className='py-10 lg:space-x-1 lg:ml-8'>
              ...
              <SocialIcon bgColor="none" fgColor="white" url='https://youtube.com'/>
              <SocialIcon bgColor="none" fgColor="white" url='https://tiktok.com'/>
            </div>
          </div>

          <div className='flex space-x-12 ml-10 mb-10 lg:grid lg:grid-cols-2 lg:space-x-0 '>
            <div className='leading-[30px]'>
                <h2 className='block text-[#5865f2] mb-5'>Produkt</h2>
                <a className='block'>Pobierz</a>
                <a className='block'>Nitro</a>
                <a className='block'>Status</a>
                <a className='block'>Katalog aplikacji</a>
            </div>
            <div className='leading-[30px]'>
                <h2 className='block text-[#5865f2] mb-5'>Firma </h2>
                <a className='block'>O nas</a>
                <a className='block'>Praca</a>
                <a className='block'>Marka</a>
                <a className='block'>Informacje prasowe</a>
            </div>
            <div className='leading-[30px] lg:mt-5'>
                <h2 className='block text-[#5865f2] mb-5'>Zasoby</h2>
                <a className='block'>Szkoła wyższa</a>
                <a className='block'>Wsparcie</a>
                <a className='block'>Bezpieczeństwo</a>
                <a className='block'>Blog</a>
                <a className='block'>Informacje zwrotne</a>
                <a className='block'>Developers</a>
                <a className='block'>StreamKit</a>
                <a className='block'>Creators</a>
            ...
            <div className='leading-[30px] lg:mt-5'>
                ...
                <a className='block'>Ustawienia ciasteczek</a>
                <a className='block'>Wytyczne</a>
                <a className='block'>Podziękowania</a>
                <a className='block'>Licencje</a>
                <a className='block'>Informacje o firmie</a>
            </div>
          </div>
        </section> 
        <section className='bg-[#23272a] lg:pb-5' >
          <div className='flex justify-between w-[1200px] mx-auto border-t-2 border-solid  pt-5 lg:w-[90%] border-[#5865f2]'>
              ...
              <button className='rounded-[40px] bg-[#5865f2] py-2 px-4'>Otwórz Discorda</button>
            </div>
        </section>   
    </div>
  )
